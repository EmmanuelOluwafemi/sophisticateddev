            ...
            <div className="container">
                <div className="heroSection">
                    ...
                    <div className="shortDetails">
                        <h6>I am</h6>
                        <h3>Iheonye Chukwuemeka</h3>
                        <p>a Product Desiner based in Lagos, Nigeria. 
                        I am in love with making users fall in love with products.</p>
                    </div>
                    </div>
                    <div className="otherDetails">
                        <ul>
                            <li>Where do you see your business in the near future? </li>
